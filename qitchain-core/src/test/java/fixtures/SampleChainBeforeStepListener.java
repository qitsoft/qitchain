 ...
 */
@Chain("sample-chain")
public class SampleChainBeforeStepListener implements ChainBeforeStepListener {

    public void onBeforeStep(ChainWorker worker, ChainStepExecutor step, ChainStorage storage) {
