 ...
 */
@Chain("sample-chain")
public class SampleChainAfterStepListener implements ChainAfterStepListener {

    public void onAfterStep(ChainWorker worker, ChainStepExecutor step, ChainStorage storage, Status status) {
