 ...
 */
public interface ChainAfterStepListener extends BaseChainListener {
    
    void onAfterStep(ChainWorker worker, ChainStepExecutor step, ChainStorage storage, ChainStepExecutor.Status status);
